...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    USEROUTEMATCH IS A FUNCTION THAT DIRECTS THE USER TO A SPECIFIC PATHING ON THE WEB APPLICATION. WHEN THE USER INTERACTS PROPERLY, THEY WILL BE DIRECTED TO A NEW PAGE WITHOUT HAVING TO RE-PING THE SERVER/'RE-PAINT' THE WHOLE PAGE FROM SCRATCH, AGAIN.

1. How would you explain form validation to someone who has never programmed before?
    FORM VALIDATION PUTS CONSTRAINTS ON THE USER'S INPUT. VALIDATION MAY REQUIRE YOU TO MAKE A MORE SECURE PASSWORD, OR ENTER YOUR FULL NAME, OR IT MIGHT EVEN BE ABLE TO TELL THAT YOU ARE TRYING TO USE A FAKE EMAIL FOR THE FORM. THROUGH A SERIES OF CONSTRAINTS, THE PROGRAMMER CAN HELP CHANNEL THE USER INTO USING INFORMATION CONSISTENT WITH THE COMPANY'S NEEDS, MONITORING, STANDARDS, OR LEGAL REQUIREMENTS.
    
1. In 1-2 sentences, define end to end testing.
    END TO END TESTING IS A FULL SUITE THAT COVERS THE FULL USER EXPERIENCE. IT IS A FULL BATTERY OF TESTS INTENDED TO FLUSH THROUGH ALL POSSIBLE ERROR POINTS IN ORDER TO IMPROVE THE UI.
